...
<body>
	<?php
       ...
       $sql = "UPDATE data SET state = '$game->state',  name2 = '$game->name2', login = '$game->login' WHERE id = 1";
   		 $pdo->query($sql);
       $pdo = null;
		 }
	?>
  ...
  <div id="sugoroku">
  		<div class="upperPart">
  			<div class="information">
  				...
  				<p><input type="button"  id="rollBtn" class="red" value="さいころを振る"></p>
    ...
    location.href = "watch2.php";
		...
		var countVal = <?= $game->count1 ?>;
		var leftVal1 = <?= 100 - $game->sum1 ?>;
		...
		var send2 = function(){
			window.location.href = "http://localhost/sugorokuOnline/updatew2.php";
		}
	</script>
