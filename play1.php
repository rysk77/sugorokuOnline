  ...
  <div id="sugoroku">
  		<div class="upperPart">
  			<div class="information">
  				<p id="turn"><?= $game->name1 ?>のターン</p>
  				<p><input type="button"  id="rollBtn" value="さいころを振る" class="red" onclick="rollDiceRed()"></p>
  				<p id="count"><?= $game->count1 ?>投目</p>
  				<p id="position">ゴールまで<?= 100 - $game->sum1 ?>マス</p>
  				<p id="goal"></p>
  		  </div>
  			<div id="result"></div>
  		</div>
	...
	<form class="none" action="updatep1.php" method="post">
		<input id="sum1" type="number" name="sum1">
		<input id="count1" type="number" name="count1">
		<input id="dice1" type="number" name="dice1">
		<input id="event" type="number" name="event">
		<input id="sb" type="submit" value="送信"　onclick="location.href='updatep1.php'">
	</form>
	<script type="text/javascript">
	var $id = function(id){ return document.getElementById(id); };
	var countVal = <?= $game->count1 ?>;　//投げた数をカウント
	var leftVal = <?= 100 - $game->sum1 ?>; //残りのマス
